...
public class Generator {
	...
	//TODO: methode generateStylerule aanpassen met een forloop + Stringbuilder
	// + generateStylerule mo
	private String generateStylerule(Stylerule stylerule) {
		String result = stylerule.selectors.get(0) + " {\n";
		result += "\t" + generateDecleration(stylerule.body.get(0));
		result += "\n}";
		return result;
 	}

	private String generateDecleration(ASTNode astNode) {
		return "Declaration";
	}
